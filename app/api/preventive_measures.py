...
from app.models.safety import PreventiveMeasure, MeasureCreate, MeasureUpdate
...
async def update_measure(measure_id: int, measure_data: MeasureUpdate):
    ...
    try:
        ...
        return PreventiveMeasure(**updated)
