...
from app.ml.multi_hazard_predictor import MultiHazardPredictor
from app.ml.multi_model_manager import MultiModelManager
from app.ml.hazard_analyzer import HazardAnalyzer
from app.services.alert_dispatcher import get_alert_dispatcher
from app.utils.logger import get_logger
from app.models.prediction import HazardPrediction, NotificationTemplate
...
async def get_forecast_summary(
    ...
    """
    try:
        from app.ml.weather_client import OpenWeatherClient
