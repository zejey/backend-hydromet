...
async def get_system_logs(
    q: Optional[str] = Query(None, description="Search query (user/action/details/role/status)"),
    ...
    sort_by: str = Query("created_at", description="created_at|status|action|user|role"),
