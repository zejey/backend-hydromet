...
async def create_category(category_data: CategoryCreate):
    ...
    try:
        with get_db_cursor() as cur:
            ...
            # ✅ Let SERIAL generate the ID automatically
            cur.execute("""
...
async def update_category(category_id: int, category_data: CategoryUpdate):  # ✅ Changed to int
    """Update category"""
    try:
        with get_db_cursor() as cur:
            update_fields = []
            ...
            return SafetyCategory(**dict(updated_category))
...
async def delete_category(category_id: int):  # ✅ Changed to int
    """Delete category"""
    try:
        with get_db_cursor() as cur:
            cur.execute("DELETE FROM safety_categories WHERE id = %s RETURNING id", (category_id,))
